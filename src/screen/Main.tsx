...
const images = [
    { id: 1, src: require('../images/screen1.jpg'), title: 'Open the digibank app, tap on PayNow and login.' },
    { id: 2, src: require('../images/screen2.jpg'), title: 'Select ‘Paynow’ from the smart shortcuts' },
    { id: 3, src: require('../images/screen3.png'), title: 'Key in the Mobile No. of the recipient' },
    { id: 4, src: require('../images/screen4.png'), title: 'Key in the amount to transfer and tap "Next' },
    { id: 5, src: require('../images/screen5.png'), title: 'Review the transfer and select Transfer now' },
    { id: 6, src: require('../images/screen6.png'), title: 'Your payment is successful!' }
];
