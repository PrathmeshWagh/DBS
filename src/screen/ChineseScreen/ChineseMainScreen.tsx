...
const ChineseMainScreen = ({ navigation }: any) => {
    const [bottomImages, setBottomImages] = useState(shuffle(images));
    const [placedImages, setPlacedImages] = useState([
        { id: 1, src: null, title: '打开digibank app, 点击 PayNow \n并登录。' },
        { id: 2, src: null, title: '点击\n“PayNow to Mobile”。' },
        { id: 3, src: null, title: '输入收款人的\n手机号码，\n并点击 “Next”。' },
        { id: 4, src: null, title: '输入转账金额，\n并点击 “Next”。' },
        { id: 5, src: null, title: '验证转账信息,\n并点击\n“Transfer Now”。' },
        { id: 6, src: null, title: '您已完成转账!' }
    ]);
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        if (currentBox === placedImages.length - 1) {
                            navigation.navigate('ChineseCompleteScreen');
                        } else {
    ...
    return (
        <View style={styles.content}>
                    ...
                    <View key={index} style={styles.column}>
                        {image.src ? (
                            ...
                            <View style={{ marginTop: 70 , }}>
                                <Text style={{ fontSize: 30, color: 'black', fontFamily:'._NotoSansSC-Black', textAlign: 'center', fontWeight:'800' }}>步骤 {index + 1} :</Text>
            ...
            <View style={{ marginVertical: 10 }}>
                <Text style={styles.heading}>进行PayNow转账的步骤是什么？{'\n'}
请按正确的顺序点击下方的屏幕</Text>
...
export default ChineseMainScreen;
