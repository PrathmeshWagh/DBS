...
const PPUScreen = ({ navigation }: any) => {
    const [bottomImages, setBottomImages] = useState(shuffle(images));
    const [placedImages, setPlacedImages] = useState([
        { id: 1, src: null, title: 'Login to digibank.' },
        { id: 2, src: null, title: "Tap on \n 'More'." },
        { id: 3, src: null, title: "Tap on \n 'Update \n Particulars'." },
        { id: 4, src: null, title: "Select \n 'Contact \n Details'."},
        { id: 5, src: null, title: "Tap on \n 'Change' to \n edit your \n contact \n details."},
        { id: 6, src: null, title: "Once done, \n review the \n request \n and tap \n 'Confirm'." }
    ]);
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        if (currentBox === placedImages.length - 1) {
                            navigation.navigate('CompletePPUScreen');
                        } else {
    ...
    return (
        <View style={styles.content}>
            ...
            <View style={{ marginVertical: 10 }}>
                <Text style={styles.heading}>What are the steps to update {'\n'} your personal particulars?</Text>
